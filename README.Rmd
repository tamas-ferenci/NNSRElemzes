...
Elsőként betöltjük a szükséges csomagokat, használni fogjuk a `data.table`-t (`r packageVersion("data.table")` verzió) és a `ggplot2`-t (`r packageVersion("ggplot2")` verzió) :
